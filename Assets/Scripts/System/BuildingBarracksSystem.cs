    ...
    public void OnUpdate(ref SystemState state)
    {
                ...
                DynamicBuffer<SpawnUnitTypeBuffer>>())
        {
            ...
            if (buildingBarracks.ValueRO.activeUnitType != spawnUnitTypeDynamicBuffer[0].unitType)
            {
                ...
                UnitTypeSO activeUnitTypeSO = GameAssets.Instance.unitTypeListSO.GetUnitTypeSO(buildingBarracks.ValueRW.activeUnitType);
            ...
            if (buildingBarracks.ValueRW.progress < buildingBarracks.ValueRO.progressMax)
            {
                continue;
            }
            ...
            UnitTypeSO unitTypeSO = GameAssets.Instance.unitTypeListSO.GetUnitTypeSO(unitType);//托管对象，不支持BurstCompiler
